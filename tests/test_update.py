...
class TestUpdate(unittest.TestCase):
    def test_update(self):
        ...
        appimage.update()
        self.assertTrue(Path("~/Downloads/App Installers/scripts/zen").exists())
        ...
        """ appimage._download(
            ...
            Path("~/Downloads/App Installers/zen-x86_64.AppImage"),
        ) """
        """ appimage2 = AppImage(
            name="heroic",
            installer=Path(
                "~/Downloads/App Installers/Heroic-2.18.1-linux-x86_64.AppImage"
            ),
